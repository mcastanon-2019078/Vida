...
import { deactivateEntity } from '../src/alerta/alerta.controller.js'
...
app.use(
  cors({
    ...
    origin: ['http://192.168.81.73:8081', 'http:/192.168.81.73:2880'], // whatever ports you used in frontend
  })
);
config()
...
app.put('/deactivate/:id', deactivateEntity)
